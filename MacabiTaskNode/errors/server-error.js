...
class ServerError extends Error {
    ...
    // An assumption: iterates through a symbol object that's contained in an array
    // in order to identify the cause of the error (Need to Ask Avi...)
    [Symbol.iterator]() {
        let current = this;
        let done = false;
        const iterator = {
    ...
    // An assumption: Retrieving the specific details of the occured error
    // (Need to Ask Avi...)
    get why() {
        let _why = '';
        for (const e of this) {
